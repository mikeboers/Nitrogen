...
Module usage:
    ...
    >>> import markdown
    >>> markdown.markdown("*boo!*")  # or use `html = markdown_path(PATH)`
    u'<p><em>boo!</em></p>\n'
...
<http://code.google.com/p/python-markdown/wiki/Extras>.
"""
...
class Markdown(object):
    ...
    def __init__(self, html4tags=False, tab_width=4, safe_mode=None,
        ...
        # For compatibility with earlier markdown.py and with
...
def main(argv=None):
    ...
    parser = optparse.OptionParser(prog="markdown", usage=usage,
